...
export function HeroSection() {
    ...
    return (
        ...
        <div ref={containerRef} className="relative bg-[#0a1c13] mt-17 flex flex-col items-center overflow-x-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] pt-32 pb-20 px-4 w-full">
                <h1 className="font-geist text-5xl md:text-6xl font-bold text-white text-center tracking-tighter max-w-5xl leading-[1.1]">
                    Nền tảng kết nối
                    <span className="text-emerald-600 hover:text-emerald-400 italic font-outfit"> Nhân tài</span> & <br />
                    <span className="text-emerald-600 hover:text-emerald-400 italic font-outfit">Ươm mầm</span> Khởi nghiệp
                </h1>

                <p className="text-emerald-50/70 max-w-2xl text-center mt-8 text-sm md:text-xl leading-relaxed">
